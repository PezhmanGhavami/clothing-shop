...
const FormModal = ({
  ...
  return (
    <div className="border bg-slate-50 dark:bg-slate-800 border-neutral-200 dark:border-slate-600 shadow-md rounded-xl p-4 mx-auto w-11/12 md:w-3/5 xl:w-2/5">
